    ...
    <ArticleStyled>
      <div className="wrapper">
        ...
        <div className="textarea">
          <span className="title-like">Политика в отношении обработки персональных данных</span>
          <br />
          1. Общие положения Настоящая политика обработки персональных данных
          составлена в соответствии с требованиями закона от
          ...
          предпринимаемые &#34;ИП Маматкулов Аброр&#34; (далее – Оператор). <br />
          ...
          https://imacode.ru.
          <br /> 2.9. Персональные данные, разрешенные <span onClick={()=>{popup()}} className="subname">субъектом</span> персональных
          данных для распространения, - персональные данные, доступ
          неограниченного круга лиц к которым предоставлен <span className="subname">субъектом</span>
          персональных данных путем дачи согласия на обработку персональных
          данных, разрешенных <span onClick={()=>{popup()}} className="subname">субъектом</span> персональных данных для распространения
          ...
          <br /> 2.14. Уничтожение персональных данных – любые действия, в
          ...
          данные; – в случае отзыва <span onClick={()=>{popup()}} className="subname">субъектом</span> персональных данных согласия на
          ...
          <br /> 3.2. Оператор обязан: – предоставлять субъекту персональных
          данных по его просьбе информацию, касающуюся обработки его
          персональных данных; – организовывать обработку персональных данных в
          порядке, установленном действующим законодательством КР; – отвечать на
          ...
          течение 30 дней с даты получения такого запроса; – публиковать или
          ...
          <br /> 4.1. Субъекты персональных данных имеют право: – получать
          ...
          работ и услуг; – на отзыв согласия на обработку персональных данных; –
          ...
          осуществление иных прав, предусмотренных законодательством КР. <br />
          ...
          <br /> 4.3. Лица, передавшие Оператору недостоверные сведения о себе,
          ...
          <br /> 5.3. Также на сайте происходит сбор и обработка обезличенных
          данных о посетителях (в т.ч. файлов «cookie») с помощью сервисов
          интернет-статистики (Яндекс Метрика и Гугл Аналитика и других).
          <br /> 5.4. Вышеперечисленные данные далее по тексту Политики
          объединены общим понятием Персональные данные.
          <br /> 5.5. Обработка специальных категорий персональных данных,
          ...
          данных. 5.7. Согласие Пользователя на обработку персональных данных,
          ...
          <br />
          5.7.2 Оператор обязан в срок не позднее трех рабочих дней с момента
          ...
          распространения. <br />
          5.7.3 Передача (распространение, предоставление, доступ) персональных
          данных, разрешенных <span onClick={()=>{popup()}} className="subname">субъектом</span> персональных данных для распространения,
          ...
          Оператору требования, указанного в п. 5.7.3 настоящей Политики в
          отношении обработки персональных данных. 6. Принципы обработки
          персональных данных
          <br /> 6.1. Обработка персональных данных осуществляется на законной и
          ...
          <br /> 6.5. Содержание и объем обрабатываемых персональных данных
          ...
          <br /> 6.7. Хранение персональных данных осуществляется в форме,
          ...
          электронной почты mmtklvaabrr@gmail.com с пометкой «Отказ от
          ...
          свободно, своей волей и в своем интересе. <br />
          ...
          предусмотренных международным договором Республики Кыргызстан или
          законом, для осуществления возложенных законодательством Республики
          Кыргызстан на оператора функций, полномочий и обязанностей. <br />
          ...
          законодательством Республики Кыргызстан об исполнительном
          производстве. <br />
          ...
          <br /> 9.5. Обработка персональных данных необходима для осуществления
          ...
          <br /> 9.6. Осуществляется обработка персональных данных, доступ
          неограниченного круга лиц к которым предоставлен <span onClick={()=>{popup()}} className="subname">субъектом </span>
          ...
          законом. 10. Порядок сбора, хранения, передачи и других видов
          ...
          выполнения в полном объеме требований действующего законодательства в
          ...
          если <span onClick={()=>{popup()}} className="subname">субъектом</span> персональных данных дано согласие Оператору на передачу
          ...
          mmtklvaabrr@gmail.com с пометкой «Актуализация персональных данных».
          ...
          электронной почты на электронный адрес Оператора mmtklvaabrr@gmail.com
          с пометкой «Отзыв согласия на обработку персональных данных». <br />
          ...
          <br />
          10.6. Установленные <span onClick={()=>{popup()}} className="subname">субъектом</span> персональных данных запреты на передачу
          ...
          определенных законодательством КР.
          <br /> 10.7. Оператор при обработке персональных данных обеспечивает
          ...
          <br /> 10.9. Условием прекращения обработки персональных данных может
          ...
          согласия <span onClick={()=>{popup()}} className="subname">субъектом</span> персональных данных, а также выявление
          ...
          Оператору с помощью электронной почты mmtklvaabrr@gmail.com. <br />
          ...
          сети Интернет по адресу https://imacode.ru/privacy.
        </div>
      </div>
    </ArticleStyled>
  );
